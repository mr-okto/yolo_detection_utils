...
def convert_labels():
    ...
    ap.add_argument("-p", "--label_path", required=False,
    ...
    for json_name in json_name_list:
        ...
        # img_path = str('%s/dataset/%s/%s.jpg' % (wd, class_name, os.path.splitext(json_name)[0]))
        ...
        if out_file_size == 0:
            ...
            # list_file.write('%s/dataset/%s/%s.jpg\n' % (wd, class_name, os.path.splitext(txt_name)[0]))
