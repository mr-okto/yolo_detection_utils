...
if __name__ == '__main__':
    ...
    ap.add_argument("-m", "--max_samples", required=False,
        default=800,
        help="Maximum number of samples to scrape")
    ...
    wd = webdriver.Chrome(DRIVER_PATH, chrome_options=options)
    queries = [args['class']]
    ...
    for query in queries:
        ...
        for i in links:
            ...
            if count % 100 == 0:
                print('%d samples complete ' % count)
            count += 1
    wd.quit()
